          ...
          regeneratorRuntime.mark(function t() {
            ...
            return regeneratorRuntime.wrap(function(t) {
              for (;;)
                switch ((t.prev = t.next)) {
                  case 0:
                    return (r = n.getDocument()), (t.next = 3), r.getTemplateKeys();
                  case 3:
                    if (
                      ((e = t.sent),
                      ...
                      e.forEach(function(t) {
                        ...
                        (n.className = 'tag-label'), n.appendChild(document.createTextNode(''.concat(t, ':'))), c.appendChild(n);
                        var r = document.createElement('textarea');
                        (r.rows = 1.4),
                          (r.className = 'value-field'),
                          (r.type = 'text'),
                          (r.name = t),
                          o && r.name in i && ((r.value = i[r.name].val), (r.rows = i[r.name].rows + 0.4)),
                          c.appendChild(r),
                          c.appendChild(document.createElement('br'));
                      }),
                        ((f = document.createElement('input')).type = 'submit'),
                        (f.name = 'Autofill'),
                        c.appendChild(f),
                        c.appendChild(document.createElement('br'));
                    }
