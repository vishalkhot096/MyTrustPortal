!(function(t) {
        ...
        (t.exports = function(t, n, r, e) {
          ...
          m
            ? ((v = r(function(t, r, e, o) {
                ...
                for (h(t, '_d', { b: i, o: p, l: u, e: c, v: new J(i) }); s < c; ) O(t, s++);
              })),
              (_ = v.prototype = E(Ut)),
              h(_, 'constructor', v))
            : (u(function() {
  ...
  function(t, n, r) {
    ...
    t.exports = function(t, n, r, v, y, d, g) {
      ...
      if (
        (j && (S = s(j.call(new t()))) !== Object.prototype && S.next && (a(S, w, !0), e || 'function' == typeof S[l] || u(S, l, h)),
        _ &&
          P &&
          'values' !== P.name &&
          ((O = !0),
      ...
      return [
        ...
        function(t, n) {
          ...
          for (var S, x = '', w = 0, _ = 0; _ < b.length; _++) {
            ...
            var M = m.groups;
            if (h) {
              var j = [O].concat(P, E, p);
              void 0 !== M && j.push(M);
              var A = String(n.apply(void 0, j));
            } else A = y(O, p, E, P, M, n);
