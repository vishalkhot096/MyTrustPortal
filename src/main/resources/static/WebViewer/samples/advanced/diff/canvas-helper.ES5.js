!(function(t) {
  ...
  function(t, n, r) {
    ...
    t.exports = function(t, n, r, v, y, d, g) {
      ...
      if (
        ...
        if (((b = { values: _ ? M : S('values'), keys: d ? M : S('keys'), entries: F }), g)) for (m in b) m in E || i(E, m, b[m]);
    ...
    if (u.ABV) {
      ...
      (b = function(t) {
        ...
        f(m.prototype, {
          ...
          getInt32: function(t) {
            return T(W(this, 4, t, arguments[1]));
          },
          getUint32: function(t) {
            return T(W(this, 4, t, arguments[1])) >>> 0;
          },
  ...
  function(t, n, r) {
    ...
    var e,
      ...
      T = function(t) {
        g.call(f, function() {
          ...
          if (
            (i &&
              ((n = x(function() {
                F ? O.emit('unhandledRejection', o, t) : (r = f.onunhandledrejection) ? r({ promise: t, reason: o }) : (e = f.console) && e.error && e.error('Unhandled promise rejection', o);
              })),
              (t._h = F || L(t) ? 2 : 1)),
            (t._a = void 0),
            i && n.e)
      ...
      k = function(t) {
        g.call(f, function() {
          var n;
          F ? O.emit('rejectionHandled', t) : (n = f.onrejectionhandled) && n({ promise: t, reason: t._v });
        });
      },
      D = function(t) {
        var n = this;
    ...
    var o = r(1),
      ...
      J = function(t, n, r) {
        return (
          ...
          (n = _(n, !0)),
          m(r),
          i(W, n) ? (r.enumerable ? (i(t, D) && t[D][n] && (t[D][n] = !1), (r = E(r, { enumerable: O(0, !1) }))) : (i(t, D) || R(t, D, O(1, {})), (t[D][n] = !0)), $(t, n, r)) : R(t, n, r)
        );
      },
      X = function(t, n) {
        m(t);
      ...
      return [
        ...
        function(t, n) {
          ...
          for (var x, S = '', w = 0, _ = 0; _ < b.length; _++) {
            m = b[_];
            for (var O = String(m[0]), E = a(s(u(m.index), h.length), 0), P = [], M = 1; M < m.length; M++) P.push(void 0 === (x = m[M]) ? x : String(x));
            var F = m.groups;
            if (p) {
              var A = [O].concat(P, E, h);
              void 0 !== F && A.push(F);
              var j = String(n.apply(void 0, A));
            } else j = y(O, h, E, P, F, n);
        ...
        [
          ...
          function(t, n) {
            ...
            for (var x = 0, S = 0, w = []; S < h.length; ) {
              ...
              var _,
                O = f(b, v ? h : h.slice(S));
              if (null === O || (_ = l(c(b.lastIndex + (v ? 0 : S)), h.length)) === x) S = u(h, S, d);
              else {
  ...
  function(t, n) {
    ...
    !(function(t) {
      ...
      function o(t, n, r, e) {
        return null == e || 0 === e || (255 === t && 255 === n && 255 === r);
      }
      function i(t, n) {
        return (t.y * n + t.x) * r;
      }
      ...
      var a = {
        ...
        handleDifferentPixelColor: function(t, r, e, o, i) {
          if (e) {
            var c = u([t[n.R], t[n.G], t[n.B]]),
              f = u([r[n.R], r[n.G], r[n.B]]),
              a = u([c, f]),
              s = a * ((Math.abs(r[n.R] - t[n.R]) + Math.abs(r[n.G] - t[n.G]) + Math.abs(r[n.B] - t[n.B])) / 765),
              l = a + s;
            return { r: l, g: a - s, b: l, a: Math.max(Math.round(255 * i), Math.round(255 * o)) };
          }
          if (o > i) {
            var h = i;
            return { r: t[n.R] * h + r[n.R] * (1 - h), g: t[n.G] * h + r[n.G] * (1 - h), b: t[n.B] * h + r[n.B] * (1 - h), a: Math.round(255 * o) };
          }
          return { r: r[n.R], g: r[n.G], b: r[n.B], a: Math.round(255 * i) };
        },
        combinePixels: function(a, s, l, h, p, v) {
          var y,
            d,
            g,
            b,
            ...
            x = a ? a.data : void 0,
            S = s ? s.data : void 0,
            w = t.Util.createCanvas(Math.max(s.width, a.width), Math.max(s.height, a.height), p),
            _ = w.getContext('2d').createImageData(w.width, w.height);
          _.data.set(x);
          for (var O = 0; O < x.length; O += r) {
            var E = ((g = O), (b = a.width), (m = void 0), { x: (m = Math.floor(g / r)) % b, y: Math.floor(m / b) }),
              P = i(E, s.width),
              M = f(x, O),
              F = f(S, P),
              A = { r: M[n.R], g: M[n.G], b: M[n.B], a: M[n.A] };
            if (o(F[n.R], F[n.G], F[n.B], F[n.A]) && o(M[n.R], M[n.G], M[n.B], M[n.A])) A = e(e({}, A), {}, { a: 0 });
            else if (
              v &&
              ((y = { r: F[n.R], g: F[n.G], b: F[n.B], a: F[n.A] }), (d = { r: M[n.R], g: M[n.G], b: M[n.B], a: M[n.A] }), y && d && y.r === d.r && y.g === d.g && y.b === d.b && y.a === d.a)
            ) {
              var j = u([M[n.R], M[n.G], M[n.B]]) / 2;
              A = e(e({}, A), {}, { r: Math.ceil(127.5) + j, g: Math.ceil(127.5) + j, b: Math.ceil(127.5) + j });
            } else if (E.y <= s.height && E.x <= s.width)
              if (o(F[n.R], F[n.G], F[n.B], F[n.A])) {
                var I = Math.round(255 * h),
                  R = u([M[n.R], M[n.G], M[n.B]]);
                A = { r: v ? R : M[n.R], g: v ? R : M[n.G], b: v ? 255 : M[n.B], a: I };
              } else if (o(M[n.R], M[n.G], M[n.B], M[n.A])) {
                var N = Math.round(255 * l),
                  T = u([F[n.R], F[n.G], F[n.B]]);
                A = { r: v ? 255 : F[n.R], g: v ? T : F[n.G], b: v ? T : F[n.B], a: N };
              } else A = this.handleDifferentPixelColor(F, M, v, h, l);
            c(_.data, O, A);
          }
          return w.getContext('2d').putImageData(_, 0, 0), w;
        },
      };
      t.CanvasHelper = a;
    })(window);
