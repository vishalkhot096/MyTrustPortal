!(function(t) {
          ...
          b
            ? ((v = r(function(t, r, e, o) {
                ...
                var i,
                  ...
                  h = 0;
                if (w(r)) {
                  if (!(r instanceof $ || 'ArrayBuffer' == (f = x(r)) || 'SharedArrayBuffer' == f)) return St in r ? Tt(v, r) : Ft.call(v, r);
                  (i = r), (h = Et(e, n));
                  var y = r.byteLength;
                  if (void 0 === o) {
  ...
  function(t, n, r) {
    ...
    t.exports = function(t, n, r, v, y, d, g) {
      ...
      var m,
        ...
        T = ('Array' == n && E.entries) || A;
      if (
        (T && (S = s(T.call(new t()))) !== Object.prototype && S.next && (a(S, w, !0), e || 'function' == typeof S[l] || u(S, l, p)),
        _ &&
          A &&
          'values' !== A.name &&
          ((O = !0),
  ...
  function(t, n, r) {
    ...
    function B(t, n, r, e, o, i) {
      ...
      for (var c = t[T]._b, f = u + t[F], a = e(+o), s = 0; s < n; s++) c[f + s] = a[i ? s : n - s - 1];
    }
    if (u.ABV) {
      if (
        !a(function() {
      ...
      (m = function(t) {
        ...
        var n = p(t);
        (this._b = d.call(new Array(n), 0)), (this[P] = n);
      }),
        (b = function(t, n, r) {
        ...
        f(b.prototype, {
          ...
          setInt16: function(t, n) {
            B(this, 2, t, C, n, arguments[2]);
          },
          setUint16: function(t, n) {
            B(this, 2, t, C, n, arguments[2]);
          },
          setInt32: function(t, n) {
            B(this, 4, t, k, n, arguments[2]);
          },
    ...
    var e,
      ...
      F = !!(function() {
        try {
          ...
          return (N || 'function' == typeof PromiseRejectionEvent) && t.then(T) instanceof n && 0 !== A.indexOf('6.6') && -1 === x.indexOf('Chrome/66');
        } catch (t) {}
      })(),
      M = function(t) {
        var n;
  ...
  function(t, n, r) {
    ...
    for (var ot = P(v.store), it = 0; ot.length > it; ) d(ot[it++]);
    c(c.S + c.F * !z, 'Symbol', {
      for: function(t) {
      ...
      return [
        ...
        function(t, n) {
          ...
          for (var S, x = '', w = 0, _ = 0; _ < m.length; _++) {
            ...
            } else P = y(O, h, E, A, N, n);
            E >= w && ((x += h.slice(w, E) + P), (w = E + O.length));
          }
          return x + h.slice(w);
        },
      ];
        ...
        [
          ...
          function(t, n) {
            ...
            for (var S = 0, x = 0, w = []; x < h.length; ) {
              ...
              var _,
                O = f(m, v ? h : h.slice(x));
              if (null === O || (_ = l(c(m.lastIndex + (v ? 0 : x)), h.length)) === S) x = u(h, x, d);
              else {
    ...
    !(function(t) {
      ...
      t.NudgeTool = {
        initializeNudgeTool: function(t) {
          ...
          i.setAttribute('id', 'nudge-diff-tool'),
            (i.innerHTML =
            ...
            (function(t) {
              var i = this,
                u = {
                  rotateCounterClockwise: e.ROTATION_DEC,
                  rotateClockwise: e.ROTATION_INC,
                  translateUp: e.VERTICAL_TRANSLATION_DEC,
                  translateLeft: e.HORIZONTAL_TRANSLATION_DEC,
                  translateRight: e.HORIZONTAL_TRANSLATION_INC,
                  translateDown: e.VERTICAL_TRANSLATION_INC,
                  scaleOut: e.SCALE_OUT,
                  scaleIn: e.SCALE_IN,
                };
              function c(t) {
                var e = u[t];
