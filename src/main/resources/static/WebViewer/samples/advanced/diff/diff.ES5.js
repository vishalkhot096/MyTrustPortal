!(function(t) {
  ...
  function(t, n, r) {
    ...
    if (r(8)) {
      ...
      v(Ut, Dt),
        h(Ut, dt, Dt.values),
        v(Ut, { slice: kt, set: Ct, constructor: function() {}, toString: ht, toLocaleString: jt }),
        Ft(Ut, 'buffer', 'b'),
        Ft(Ut, 'byteOffset', 'o'),
        Ft(Ut, 'byteLength', 'l'),
        Ft(Ut, 'length', 'e'),
    ...
    var o = r(1),
      ...
      H =
        ...
        s(function() {
          ...
          : N,
      $ = function(t) {
        var n = (V[t] = O(j.prototype));
        return (n._k = t), n;
      },
      K =
        Y && 'symbol' == e(j.iterator)
          ? function(t) {
              return 'symbol' == e(t);
            }
          : function(t) {
      ...
      tt = function(t) {
        for (var n, r = R(w(t)), e = [], o = 0; r.length > o; ) i(V, (n = r[o++])) || n == C || n == f || e.push(n);
        return e;
      },
      nt = function(t) {
        for (var n, r = t === G, e = R(r ? U : w(t)), o = [], u = 0; e.length > u; ) !i(V, (n = e[u++])) || (r && !i(G, n)) || o.push(V[n]);
        return o;
      };
    Y ||
      (a(
        ...
        return new Promise(function(u) {
          ...
          WebViewer(
            ...
            var o = r.UI,
              ...
              l = o.LayoutMode,
              y = o.FitMode;
            o.disableFeatures([c.Annotations]),
              o.setToolMode('AnnotationEdit'),
              i.addEventListener('documentLoaded', function() {
                ...
                var r = g.querySelector('iframe').contentDocument.querySelector('.DocumentContainer');
                (r.onscroll = function() {
                  var e, o;
                  ...
                  i.addEventListener('zoomUpdated', function(e) {
                    a ||
                      ((a = r),
                      clearTimeout(n),
                      (n = setTimeout(function() {
                  ...
                  (s[e.panel].documentContainer = r);
              }),
              f.push(e),
              (s[e.panel] = { instance: r }),
              u();
          });
        });
      }
