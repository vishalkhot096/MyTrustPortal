  ...
  function(t, n, r) {
    ...
    if (r(8)) {
      var o = r(30),
        ...
        Tt = function() {
          return vt.apply(kt ? pt.call(Ot(this)) : Ot(this), arguments);
        },
        Lt = {
      ...
      v(Vt, Ct),
        h(Vt, yt, Ct.values),
        v(Vt, { slice: Rt, set: Dt, constructor: function() {}, toString: ht, toLocaleString: Tt }),
        It(Vt, 'buffer', 'b'),
        It(Vt, 'byteOffset', 'o'),
        It(Vt, 'byteLength', 'l'),
        It(Vt, 'length', 'e'),
    ...
    var o = r(1),
      ...
      J = function(t, n, r) {
        return (
          ...
          (n = _(n, !0)),
          b(r),
          i(U, n) ? (r.enumerable ? (i(t, D) && t[D][n] && (t[D][n] = !1), (r = P(r, { enumerable: E(0, !1) }))) : (i(t, D) || N(t, D, E(1, {})), (t[D][n] = !0)), q(t, n, r)) : N(t, n, r)
        );
      },
      X = function(t, n) {
        b(t);
      ...
      tt = function(t) {
        for (var n, r = k(w(t)), e = [], o = 0; r.length > o; ) i(U, (n = r[o++])) || n == D || n == f || e.push(n);
        return e;
      },
      nt = function(t) {
        for (var n, r = t === G, e = k(r ? V : w(t)), o = [], u = 0; e.length > u; ) !i(U, (n = e[u++])) || (r && !i(G, n)) || o.push(U[n]);
        return o;
      };
    z ||
      (a(
